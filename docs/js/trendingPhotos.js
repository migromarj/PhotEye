...
function addTPhotos1ToContainer(photos, galleryContainer){
    let gallery = galleryRenderer.asCardTPhotos1Gallery(photos);
    galleryContainer.appendChild(gallery);
}

function addTPhotos2ToContainer(photos, galleryContainer){
    let gallery = galleryRenderer.asCardTPhotos2Gallery(photos);
    galleryContainer.appendChild(gallery);
}

//Loads the content in trendsphotos.html 
...
function main() {
    ...
    trendingsAPI.getTPhotos1()
             .then(photos => addTPhotos1ToContainer(photos, galleryContainer1))
    ...
    trendingsAPI.getTPhotos2()
            .then(photos => addTPhotos2ToContainer(photos, galleryContainer2))
            .catch(error => messageRenderer.showErrorMessage(error));
}
